...
type FederationcontrollerV1alpha2Interface interface {
...
// NewForConfig creates a new FederationcontrollerV1alpha2Client for the given config.
...
// NewForConfigAndClient creates a new FederationcontrollerV1alpha2Client for the given config and http client.
...
func NewForConfigAndClient(c *rest.Config, h *http.Client) (*FederationcontrollerV1alpha2Client, error) {
	...
	return &FederationcontrollerV1alpha2Client{client}, nil
}

// NewForConfigOrDie creates a new FederationcontrollerV1alpha2Client for the given config and
...
func New(c rest.Interface) *FederationcontrollerV1alpha2Client {
	return &FederationcontrollerV1alpha2Client{c}
}
